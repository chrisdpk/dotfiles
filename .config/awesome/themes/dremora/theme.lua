...
awful.util.tagnames   = { "www", "term", "code", "mail", "var", "irc" }
...
local net = lain.widget.net({
	...
	widget:set_markup(markup.font(theme.font, markup(gray, " Net ") .. markup(white,net_now.received .. " / " .. net_now.sent .. " kb")))
	end
})
-- ALSA volume
...
theme.weather = lain.widget.weather({
    city_id = 2947416, -- placeholder (London)
    notification_preset = { fg = white },
    settings = function()
    	widget:set_markup(markup.font(theme.font,markup(gray, " Weather ") .. markup(white, weather_now["main"]["temp"]) .. markup(white, "°C")))
    end
})
...
local cpu = lain.widget.cpu({
    timeout = 2,
    settings = function()
        widget:set_markup(markup.font(theme.font, markup(gray, " CPU ") ..  markup(white, cpu_now.usage .. "%")))
    end
})
...
local mem = lain.widget.mem({
	timeout = 2,
	settings = function()
		widget:set_markup(markup.font(theme.font, markup(gray, " MEM ") .. markup(white, mem_now.used .. " MiB")))
	end
